...
var Dataset_1 = __webpack_require__(9);
// 全局属性
// let Surong = {
//     SStorage,
//     SLocation,
...
// 全局变量
window.Surong = {
    SStorage: storage_1.default,
    SLocation: location_1.default,
 ...
 * Joshua Conero
 */
var Susanna_1 = __webpack_require__(2);
// 储存器
var SusannaStorage = /** @class */ (function () {
    /**
     * @param {string|null} ns 命名空间，为空时值全局变量
     * @param {string} dirver SESSION/LOCAL
     * @param {bool} noDecode 不进行base64 编码
     */
    function SusannaStorage(ns, dirver, noDecode) {
        this.dirver = dirver || 'session';
        if (this.dirver)
            this.dirver = this.dirver.toUpperCase();
        this.ns = ns || null;
     ...
     * @param {any} def
     */
    SusannaStorage.prototype.Get = function (key, def) {
        def = def || null;
        if (this.ns) {
    ...
    SusannaStorage.prototype.hasKey = function (key) {
    };
    /**
     * 链式后去值
     * @param {string} key
     ...
     */
    SusannaStorage.prototype.GetCallback = function (key, callback) {
        if (key) {
     ...
     * @return {SusannaStorage}
     */
    SusannaStorage.prototype.Set = function (key, value, commit) {
     ...
     * @return {SusannaStorage}
     */
    SusannaStorage.prototype.Del = function (keys, commit) {
     ...
     * @return {Object}
     */
    SusannaStorage.prototype.GetRawJson = function () {
        var json = {};
        if (this.ns) {
            if ('SESSION' == this.dirver) {
                ...
                if (value) {
                    if (!this.noDecode) {
                        json = Susanna_1.default.base64_decode(value);
                    }
     ...
     * @return {bool}
     */
    SusannaStorage.prototype.Save = function () {
        if (!Susanna_1.default.EmptyJson(this.rawJson)) {
            // console.log(this.rawJson)
            if (this.ns) {
                var value = JSON.stringify(this.rawJson);
                if (!this.noDecode) {
                    value = Susanna_1.default.base64_encode(value);
                }
                if ('SESSION' == this.dirver) {
...
exports.default = SusannaStorage;
 ...
 * 从 center.vue.js 中独立
 */
var Susanna = /** @class */ (function () {
    function Susanna() {
    }
    Susanna.base64_decode = function (encodeStr) {
        return new Buffer(encodeStr, 'base64').toString('base64');
    };
    Susanna.base64_encode = function (Str) {
     ...
     * @return {bool}
     */
    Susanna.EmptyJson = function (json) {
        var isEmpty = true;
     ...
     * @memberof Susanna
     */
    Susanna.render = function (str, callback) {
        var reg = /\{[^\}]+\}/g;
...
var SLocation = /** @class */ (function () {
     ...
     * @return {string|JSON}
     */
    SLocation.getQuery = function (key, url) {
        /*
        if('#' == key){
     ...
     * @return {string}
     */
    SLocation.updateUrl = function (json, url) {
        var newUrl = '';
        if ('object' != typeof json) {
            json = {};
        }
        json = Object.assign(json, SLocation.getQuery(null, url));
        var urlQueue = [];
        for (var k in json) {
     ...
     * @param {string} url
     */
    SLocation.parseUrl = function (url) {
        var json = {
            hash: '',
            search: '',
            base: ''
...
var Dataset = /** @class */ (function () {
     ...
     * @return {bool}
     */
    Dataset.prototype.merge = function (data) {
        var success = false;
        if ('object' == typeof data) {
            SuRongDataSets[this.$id] = Object.assign(SuRongDataSets[this.$id], data);
            success = true;
        }
        return success;
    };
     ...
     * @return {any}
     */
    Dataset.prototype.getValue = function (key, def) {
        def = def || null;
     ...
     * @return {bool}
     */
    Dataset.prototype.deleteKey = function (key) {
     ...
     * @return {bool}
     */
    Dataset.prototype.hasKey = function (key) {
     ...
     * @returns {any}
     */
    Dataset.prototype.value = function (key, value, def) {
        var rs = false;
        // 获取数据
